...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Tambah Mesin Absensi</h2>
        </div>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" 
                           ...
                           placeholder="Contoh: Mesin Fingerprint Lantai 1"
                           required>
                    @error('name')
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="port" value="{{ old('port', 4370) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="location" value="{{ old('location') }}" 
                           ...
                           placeholder="Contoh: Lantai 1 - Ruang Receptionist">
                    @error('location')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                              ...
                              placeholder="Keterangan tambahan tentang mesin ini">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
